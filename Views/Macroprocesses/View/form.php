...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/organization/macroprocesses/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["macroprocess"] . $f->fields["name"] . $f->fields["description"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Macroprocesses.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
