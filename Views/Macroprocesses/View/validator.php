...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Macroprocesses.view-errors-title"));
    $smarty->assign("message", lang("Macroprocesses.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "organization/macroprocesses-view-errors-message.mp3");
