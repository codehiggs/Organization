...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Organization.plans-view-errors-title"));
    $smarty->assign("message", lang("Organization.plans-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "organization/plans-view-errors-message.mp3");
