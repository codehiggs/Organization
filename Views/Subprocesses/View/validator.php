...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Subprocesses.view-errors-title"));
    $smarty->assign("message", lang("Subprocesses.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "organization/subprocesses-view-errors-message.mp3");
