...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("process", "trim|required");
$f->set_ValidationRule("macroprocess", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Processes.view-errors-title"));
    $smarty->assign("message", lang("Processes.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "organization/processes-view-errors-message.mp3");
