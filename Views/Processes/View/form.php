...
$f = service("forms", array("lang" => "Organization_Processes."));
//[Request]-----------------------------------------------------------------------------
$row = $model->find($oid);
...
$back = "/organization/processes/list/" . lpk();
//[Fields]-----------------------------------------------------------------------------
$f->fields["process"] = $f->get_FieldView("process", array("value" => $r["process"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["macroprocess"] = $f->get_FieldView("macroprocess", array("value" => $r["macroprocess"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/organization/processes/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["process"] . $f->fields["macroprocess"] . $f->fields["name"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["description"] . $f->fields["responsible"] . $f->fields["author"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Processes.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
