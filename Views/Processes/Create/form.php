...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["process"] = $f->get_Value("process", pk());
$r["macroprocess"] = $f->get_Value("macroprocess", $oid);
...
$back = "/organization/processes/list/{$oid}";
...
$card = $b->get_Card("create", array(
    "title" => lang("Processes.create-title"),
